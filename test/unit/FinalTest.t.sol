...
contract DSCEngineTest is StdCheats, Test {
    ...
    ///////////////////////////////////////
    // depositCollaterAndMintDsc Tests //
    ///////////////////////////////////////
    ...
    function testRevertsIfMintedDscBreaksHealthFactor() public {
        ...
        dsce.depositCollaterAndMintDsc(weth, amountCollateral, amountToMint);
        vm.stopPrank();
    }
    ...
    function testRevertsIfMintFails() public {
        ...
        mockDsce.depositCollaterAndMintDsc(weth, amountCollateral, amountToMint);
        vm.stopPrank();
    }
    ...
    function testMustImproveHealthFactorOnLiquidation() public {
        ...
        mockDsce.depositCollaterAndMintDsc(weth, collateralToCover, amountToMint);
    ...
    function testCantLiquidateGoodHealthFactor() public depositedCollateralAndMintedDsc {
        ...
        dsce.depositCollaterAndMintDsc(weth, collateralToCover, amountToMint);
        dsc.approve(address(dsce), amountToMint);
    ...
    modifier liquidated() {
        ...
        MockV3Aggregator(ethUsdPriceFeed).updateAnswer(ethUsdUpdatedPrice);
        uint256 userHealthFactor = dsce.getHealthFactor(user);
      ( ,uint256 beforeliq)=dsce.getAccountInformation(user);
